    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <div className="fixed top-0 left-0 right-0 h-16 bg-white border-b border-slate-200 z-30 lg:hidden flex items-center justify-between px-4">
        ...
        <div className="flex items-center gap-2">
          <img src="/imgs/autosam1.jpg" alt="Logo" className="h-8 w-auto object-contain" />
      ...
      `}>
        {/* Logo */}
        <div className={`p-4 border-b border-slate-200 flex items-center bg-gradient-to-r from-white to-slate-50 ${collapsed ? 'justify-center' : 'justify-between'}`}>
          {!collapsed && (
          ...
          <button
            ...
            className={`hidden lg:flex p-1.5 text-slate-400 hover:text-slate-600 hover:bg-slate-100 rounded-lg transition-colors ${collapsed ? 'mt-3' : ''}`}
        ...
        {/* User section */}
        <div className={`p-4 border-t border-slate-200 bg-gradient-to-b from-white to-slate-50 ${collapsed ? 'flex flex-col items-center gap-3' : ''}`}>
          {!collapsed ? (
            <>
              <div className="flex items-center gap-3 mb-4 p-2 bg-white rounded-xl shadow-sm border border-slate-100">
                ...
                <div className="w-2 h-2 bg-emerald-500 rounded-full" title="En ligne" />
              </div>
              <button
            ...
            <>
              {/* Avatar only */}
              <div className="w-10 h-10 bg-gradient-to-br from-red-500 to-red-600 rounded-full flex items-center justify-center shadow-md relative" title={admin?.username}>
                <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
              ...
              <button
                onClick={handleLogout}
                title="Déconnexion"
                className="w-10 h-10 flex items-center justify-center text-red-600 bg-white hover:bg-red-50 border border-slate-200 hover:border-red-200 rounded-xl transition-all duration-200 shadow-sm hover:shadow"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                </svg>
