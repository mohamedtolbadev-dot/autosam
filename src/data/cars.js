...
export const cars = [
  ...
  },
  {
    ...
    fuel: 'Diesel',
    available: true,
    image: 'https://www.dacia.fr/content/dam/rhd/offers/vehicles/logan-mcv-jogger/visuals/dacia-logan-mcv-2021-front-three-quarter.png',
    year: 2023,
    doors: 5,
    luggage: 4,
    airConditioning: true,
  ...
  },
  {
    ...
    fuel: 'Essence',
    available: true,
    image: 'https://www.peugeot.fr/content/dam/peugeot/master/vehicles/208/visuels/208-front-view.png',
    year: 2024,
    doors: 5,
    luggage: 3,
    airConditioning: true,
  ...
  },
  {
    ...
    fuel: 'Diesel',
    available: true,
    image: 'https://www.hyundai.com/content/hyundai/ww/data/news/data/2021/08/09/hyundai-tucson-2021-1.jpg',
    year: 2023,
    doors: 5,
    luggage: 5,
    airConditioning: true,
